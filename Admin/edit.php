...
<body>
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="department" type="text" class="form-control" id="validationCustom02" value="<?php echo $depatment  ?>" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input name="salary" type="number" class="form-control" id="validationCustom02" value="<?php echo $salary  ?>" >
        </div>
...
if(isset($_SESSION["email"])){
    if(isset($_POST["submitbtn"])){
        ...
        $sql1 = "UPDATE `employee` SET `salary`='$salary',`department`='$depatment',`degree` = '$degree', `fname` = '$fname', `lname` = '$lname',`bdate` = '$bdate',`gender`='$gender',`email`='$email',`cnumber`='$cnumber',`address`='$address' WHERE `id`=$id;" ;
